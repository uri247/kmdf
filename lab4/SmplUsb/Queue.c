...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, SmplUsbQueueInitialize)
#endif

NTSTATUS
SmplUsbQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = SmplUsbEvtIoDeviceControl;
    queueConfig.EvtIoStop = SmplUsbEvtIoStop;
